...
define(
	'code25.FlexitogGlobal.Menu.MyAccount', [
		'SC.Configuration', 'Profile.Model', 'code25_flexitogglobal_menu_myaccount.tpl', 'Backbone', 'underscore', 'jQuery', 'ProductList.Utils'
	],
	function (
		Configuration, ProfileModel, code25_flexitogglobal_menu_myaccount_tpl, Backbone, _, jQuery, ProductListUtils
	) {
		'use strict';
